...
CREATE TABLE `branch` (
    ...
    CONSTRAINT `FK_branch_company` FOREIGN KEY (`companyId`)
...
CREATE TABLE `employee` (
    ...
    CONSTRAINT `FK_employee_res` FOREIGN KEY (`residentType`)
        REFERENCES `types` (`id`),
    CONSTRAINT `FK_employee_curr` FOREIGN KEY (`currency`)
        REFERENCES `types` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `emp_payroll` (
    ...
    `paidEmpeSS` double default 0,
    `paidEmprSS` double default 0,
    ...
    `retroBaseSal` double default 0,
    `newOtherIncome` double default 0,
    `newOvertimeAmt` double default 0,
    `newBonus` double default 0,
    `paidBaseSalary` double default 0,
    ...
    CONSTRAINT `FK_emp_payroll_emp` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`),
    CONSTRAINT `FK_emp_payroll_acc` FOREIGN KEY (`accomodationType`)
        REFERENCES `types` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `benefit` (
    ...
    `perMonthAmt` double NOT NULL,
    `employeeId` int(10) unsigned NOT NULL,
    `version` int(11) NOT NULL default '1',
    PRIMARY KEY (`id`),
    KEY `FK_benefit_type` (`typeId`),
    KEY `FK_benefit_employee` (`employeeId`),
    CONSTRAINT `FK_benefit_employee` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`),
    CONSTRAINT `FK_benefit_type` FOREIGN KEY (`typeId`)
        REFERENCES `benefitype` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `deduction` (
    ...
    CONSTRAINT `FK_dedecuction_emp` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`),
    CONSTRAINT `FK_dedecuction_type` FOREIGN KEY (`deductionType`)
...
CREATE TABLE `leaveapproval` (
    ...
    CONSTRAINT `FK_leaveapproval_employee` FOREIGN KEY (`approverId`)
        REFERENCES `employee` (`id`),
    CONSTRAINT `FK_leaveapproval_request` FOREIGN KEY (`requestId`)
...
CREATE TABLE `deduction_decl` (
    ...
    CONSTRAINT `FK_deduction_decl` FOREIGN KEY (`payrollId`)
        REFERENCES `emp_payroll` (`id`),
    CONSTRAINT `FK_deduction_type` FOREIGN KEY (`type`)
        REFERENCES `deductiontype` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `deduction_done` (
    ...
    CONSTRAINT `FK_deducdone_emp` FOREIGN KEY (`payrollId`)
        REFERENCES `emp_payroll` (`id`),
    CONSTRAINT `FK_deducdone_type` FOREIGN KEY (`type`)
        REFERENCES `deductiontype` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `exemptions_done` (
    ...
    CONSTRAINT `FK_exemptions_emp` FOREIGN KEY (`payrollId`)
        REFERENCES `emp_payroll` (`id`),
    CONSTRAINT `FK_exemptions_type` FOREIGN KEY (`type`)
        REFERENCES `exemptionstype` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `emp_dependents` (
    ...
    CONSTRAINT `FK_dependents_emp` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`),
    CONSTRAINT `FK_dependents_occ` FOREIGN KEY (`occupationType`)
        REFERENCES `types` (`id`),
    CONSTRAINT `FK_dependents_type` FOREIGN KEY (`depType`)
        REFERENCES `types` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `licenses` (
    ...
    CONSTRAINT `FK_licenses_comp` FOREIGN KEY (`companyId`)
        REFERENCES `company` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `employee_account` (
    ...
    CONSTRAINT `FK_empacc_emp` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `glemployee` (
    ...
    CONSTRAINT `FK_glemployee_employee` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table `taxrates` (
    ...
    CONSTRAINT `FK_taxrates_type` FOREIGN KEY (`residentTypeId`)
        REFERENCES `types` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table `taxdetails` (
    ...
    CONSTRAINT `FK_taxdetails_type` FOREIGN KEY (`typeId`)
        REFERENCES `types` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table `emp_salary` (
    ...
    CONSTRAINT `FK_empsal_emp` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table `emp_bonus` (
    ...
    CONSTRAINT `FK_empbonus_emp` FOREIGN KEY (`employeeId`)
        REFERENCES `employee` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `payroll_date` (
    ...
    CONSTRAINT `FK_paydate_branch` FOREIGN KEY (`branchId`)
        REFERENCES `branch` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `payroll` (
    ...
    CONSTRAINT `FK_payroll_run_by_user` FOREIGN KEY (`runBy`)
        REFERENCES `users` (`id`),
    CONSTRAINT `FK_payroll_branch` FOREIGN KEY (`branchId`)
        REFERENCES `branch` (`id`),
    CONSTRAINT `FK_payroll_paydate` FOREIGN KEY (`payDateId`)
        REFERENCES `payroll_date` (`id`)
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `emp_payroll_map` (
    ...
    `retroBaseSal` double NOT NUll,
    `currencyConverRate` double NOT NUll,
    `salPayDate` int(10) unsigned NOT NULL,
    ...
    CONSTRAINT `FK_emppaymap_emp` FOREIGN KEY (`emppayId`)
        REFERENCES `emp_payroll` (`id`),
    CONSTRAINT `FK_emppaymap_payroll` FOREIGN KEY (`payrollId`)
...
CREATE TRIGGER audit_employee_entry BEFORE UPDATE ON employee
  FOR EACH ROW BEGIN
	...
	VALUES(OLD.id, OLD.employeeId, OLD.firstname, OLD.middlename, OLD.lastname, OLD.sex, OLD.birthdate,
	  ...
	  OLD.phoneNo, OLD.nationality, OLD.ppNumber, OLD.ppExpDate, OLD.ppIssuePlace, OLD.currency, NOW());
  END;
$$
