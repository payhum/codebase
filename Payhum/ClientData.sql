...
INSERT INTO `position` (`id`,`name`,`lowsal`,`highsal`) VALUES 
 ...
 (2,'Staff_2',100000,1200000),
 (3,'Staff_3',200000,4000000);
...
INSERT INTO `employee` (`id`,`employeeId`,`firstname`,`middlename`,`lastname`,`sex`,`birthdate`,`hiredate`,`positionId`,`photo_path`,`status`,`version`,`married`,`residentType`,`deptId`,`empNationalID`,`emerContactName`,`emerContactNo`,`address`,`phoneNo`) VALUES 
 (1,'CLI-0000','Guest',' ',' ','Male','1980-06-19 00:00:00','2011-06-14 00:00:00',3,'/data/photo/185145_481927465161666_2082997324_n.jpg','ACTIVE',1,'true',11,1,'N1','A','1','address1','123456'),
 (2,'CLI-0001','JOHN','B','WIN','Male','1980-06-19 00:00:00','2011-06-14 00:00:00',3,'/data/photo/185145_481927465161666_2082997324_n.jpg','ACTIVE',1,'true',11,1,'N1','A','1','address1','123456');
...
INSERT INTO `users` (`id`,`username`,`password`,`employeeId`,`roleId`,`version`) VALUES 
 (1,'guest','welcome',1,5,1),
 (2,'John','welcome',2,5,1);
