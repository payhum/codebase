...
public class UpdateBenefitAction extends Action {
	@Override
    public ActionForward execute(ActionMapping map,
        ...
        for (Benefit btFromJSON : aCollection) {
            ...
            bt.setAmount(btFromJSON.getAmount());
            bt.setTypeId(btFromJSON.getTypeId()); 
            bt.setEmployeeId(btFromJSON.getEmployeeId()); 
            BenefitFactory.update(bt);
        }
