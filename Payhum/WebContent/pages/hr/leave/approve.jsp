	...
	$(document).ready(function(){
		...
		$("#grid").delegate(".approve", "click", function(e) {
			...
			/*e.preventDefault(); 	        	 
       		...
       		var approverId = "<%=(request.getSession().getAttribute("loggedEmployee")!=null ? request.getSession().getAttribute("loggedEmployee") : "")%>";
       		var approvedByDate = new Date().getTime(); 
       		var approvalData = JSON.stringify([{"approvedbydate" : approvedByDate, "approverId" : approverId, "requestId" : leaveId}]); 
