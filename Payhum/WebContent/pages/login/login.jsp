    ...
    <html:form action="/LoginAction" styleClass="loginForm">
		...
		<div>
			...
			<label><bean:message key="userName"/></label><br />
		   	<html:text property="username" styleId="userName" value=""  tabindex="1"/><br />
       
           	<label><bean:message key="password"/></label><br />
           	<html:password property="password" styleId="passWord" value="" tabindex="2"/><br /><br />
          	...
          	<div class="roleSelectorWindow" style="display:block;padding:0;">
				...
				<button id="setLoginAs" class="k-button" tabindex="4" >Login</button>
			</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#setLoginAs").bind("click","keypress", function(e){
